...
function Library:CreateWindow(WindowInfo)
    ...
    WindowInfo.SidebarCompactWidth = math.max(44, WindowInfo.SidebarCompactWidth)
    ...
    local InitialLeftWidth = WindowInfo.SidebarCompactWidth or 40
    ...
    local function ApplyCompact()
        ...
        for _, Button in Library.TabButtons do
            ...
            Button.Padding.PaddingBottom = UDim.new(0, 0)
            Button.Padding.PaddingLeft = UDim.new(0, 0)
            Button.Padding.PaddingRight = UDim.new(0, 0)
            Button.Padding.PaddingTop = UDim.new(0, 0)
    ...
    function Window:SetSidebarWidth(Width)
        Width = math.clamp(Width, 44, MainFrame.Size.X.Offset - WindowInfo.MinContainerWidth - 1)
    ...
    function Window:AddTab(...)
        ...
        function Tab:Show()
            ...
            local Line = TabButton:FindFirstChild("SelectionLine")
            if Line then
                TweenService:Create(Line, Library.TweenInfo, {
                    BackgroundTransparency = 0,
                }):Play()
            end
